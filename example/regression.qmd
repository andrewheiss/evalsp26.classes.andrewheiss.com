...
You can also download a complete `.zip` file with a finished Quarto file that you can render and play with on your own:
...
library(parameters)    # This lets you extract model parameters into nice tables
library(performance)   # This lets you extract model diagnostics into nice tables
...
model_parameters(model_sat_gpa, digits = 3)
```
...
model_performance(model_sat_gpa)
```
...
model_parameters(model_sat_gpa_types, digits = 3)
```
...
model_performance(model_sat_gpa_types)
```
...
model_parameters(model_sat_gpa_hs, digits = 3)
```
...
model_performance(model_sat_gpa_hs)
```
...
model_parameters(model_sat_sex, digits = 3)
```
...
model_performance(model_sat_sex)
```
...
model_parameters(model_sat_hs_sex, digits = 3)
```
...
model_performance(model_sat_hs_sex)
```
