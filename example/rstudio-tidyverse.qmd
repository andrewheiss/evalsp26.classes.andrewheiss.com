...
The content from these primers comes from the (free and online!) book [*R for Data Science* by Garrett Grolemund and Hadley Wickham](https://r4ds.hadley.nz/). I highly recommend the book as a reference and for continuing to learn and use R in the future.
...
To get familiar with RStudio, watch this video (it's from my data visualization class, but the content still applies here): 
...
[Read this super short chapter on RStudio projects to learn how to create and use them](https://r4ds.hadley.nz/workflow-scripts.html#projects)
...
2. Watch this video (again, it's from data visualization *and* it's about R Markdown instead of Quarto, but the content works for this class):
