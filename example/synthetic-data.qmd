...
model_parameters(model_happiness1)
```
...
model_parameters(model_happiness2)
```
...
model_parameters(model_happiness3)
```
...
model_parameters(model_does_this_work_yet)
```
...
model_parameters(model_happiness_naive)
```
...
model_parameters(model_happiness_ate)
```
...
model_parameters(model_noisier)
```
...
```{r}
lm(outcome ~ treatment, data = temp_data) |> model_parameters()
```
