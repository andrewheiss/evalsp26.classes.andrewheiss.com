...
- [{{< fa laptop-code >}} Generating random numbers](/example/random-numbers.qmd)
- [{{< fa laptop-code >}} The ultimate guide to generating synthetic data for causal inference](/example/synthetic-data.qmd)
:::
...
1. Open the project either on your computer ([follow these instructions to get started!](/resource/install.qmd)) or in Posit.cloud
   ...
   - [{{< fa file-archive >}} `09-problem-set.zip`](/projects/09-problem-set.zip): If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `09-problem-set.Rproj`
   - [{{< fa cloud >}} Posit.cloud project](https://posit.cloud/spaces/737332/content/12204177): Use this link if you're using Posit.cloud in your browser

2. Rename the Quarto file named `your-name_09-problem-set.qmd` to something that matches your name and open it in RStudio.
