...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `problem-set-9.Rproj`: [{{< fa file-archive >}} `problem-set-9.zip`](/projects/problem-set-9.zip)
   ...
   (Alternatively, you can open the project named "Problem Set 9" on Posit.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://posit.cloud/spaces/599025/content/10130383)—if it doesn't, log in and look for the project named "Problem Set 9.")

2. Rename the Quarto file named `your-name_problem-set-9.Rmd` to something that matches your name and open it in RStudio.
