...
For your final project in this class, you will write a pre-registered analysis of a public or nonprofit social program that you're interested in. **You will not use any real data.** Instead, [you'll create a synthetic dataset for your pre-analysis.](/example/synthetic-data.qmd)

You will submit **three things** via iCollege:

1. A rendered PDF of your report, compiled with Quarto (see the outline below for details of what this needs to contain). This should have *no visible R code, warnings, or messages in it* (set `execute: echo: false` at the beginning of your document before you render).
2. The same PDF as above, but with all the R code in it (set `execute: echo: true` at the beginning of your document and re-render the file).
3. A CSV file of [your fake data.](/example/synthetic-data.qmd)

This project is due by **11:59 PM on Monday, May 4, 2025.** <span style="color: #81056F; font-weight: bold"> No late work will be accepted.</span>

I will grade your project using this rubric. I *highly* recommend that you refer to the rubric as you work on your project!

- {{< fa list-check >}}&ensp;[`evalsp26_final-project-rubric.xlsx`](/files/evalsp26_final-project-rubric.xlsx)
...
- [{{< fa file-archive >}} Empty RStudio project you can download and unzip on your computer](/projects/final-project.zip)
...
Here's an outline of what you'll need to do. You did lots of this work in your evaluation assignments. Please don't just copy/paste those assignments as is into this final project—you'll want to polish it up for this final report. 

I've included this in the downloadable .zip file and in the empty Posit.cloud project.
...
Download this here (or download the project .zip above):
