...
**I've created a Quarto template you can use here:** [{{< fa file-archive >}} `background-theory.zip`](/projects/background-theory.zip). It's also [available on Posit.cloud](https://posit.cloud/spaces/599025/content/9520198).
