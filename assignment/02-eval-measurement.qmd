...
You need to complete the two sections listed below. Ideally you should type this in a Quarto file and render your document to HTML or Word or PDF, but you can also write in Word if you want (though your final project will need to be in Quarto, and this would give you practice).[^citations]

[^citations]: And if you want to be super brave, try using [Quarto's citation system](/resource/markdown.qmd#citations)!

**I've created a Quarto template you can use here:** [{{< fa file-archive >}} `measurement.zip`](/projects/measurement.zip). It's also [available on Posit.cloud](https://posit.cloud/spaces/737332/content/11860614).
...
Read [this article about half-day vs. full-day kindergarten in Utah](https://archive.sltrib.com/story.php?ref=/news/ci_13164697). The article is more than 10 years old, and half-day kindergarten *still* remains standard practice in most Utah school districts.
...
Make a list of **two** (2) possible outcomes of your selected program. For each of those outcomes, make a list of all the possible attributes. Narrow this list down to 2–3 key attributes. Discuss how you decided to narrow the concepts and justify why you think these attributes capture the outcome. *(≈100 words)*
