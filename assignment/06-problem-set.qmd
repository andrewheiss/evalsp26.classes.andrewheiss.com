...
For this problem set, you'll practice doing regression discontinuity analysis with R.
...
- [{{< fa laptop-code >}} Regression discontinuity](/example/rdd.qmd)
:::
...
1. Open the project either on your computer ([follow these instructions to get started!](/resource/install.qmd)) or in Posit.cloud
   ...
   - [{{< fa file-archive >}} `06-problem-set.zip`](/projects/06-problem-set.zip): If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `06-problem-set.Rproj`
   - [{{< fa cloud >}} Posit.cloud project](https://posit.cloud/spaces/737332/content/12183955): Use this link if you're using Posit.cloud in your browser

2. Rename the Quarto file named `your-name_06-problem-set.qmd` to something that matches your name and open it in RStudio.
