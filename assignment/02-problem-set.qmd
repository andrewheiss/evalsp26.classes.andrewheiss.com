...
- [{{< fa laptop-code >}} Regression](/example/regression.qmd)
:::
...
1. Open the project either on your computer ([follow these instructions to get started!](/resource/install.qmd)) or in Posit.cloud
   ...
   - [{{< fa file-archive >}} `02-problem-set.zip`](/projects/02-problem-set.zip): If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `02-problem-set.Rproj`
   - [{{< fa cloud >}} Posit.cloud project](https://posit.cloud/spaces/737332/content/11752926): Use this link if you're using Posit.cloud in your browser

2. Rename the Quarto file named `your-name_02-problem-set.qmd` to something that matches your name and open it in RStudio.
