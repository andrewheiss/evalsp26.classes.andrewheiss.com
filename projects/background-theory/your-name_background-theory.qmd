...
subtitle: "Evaluation, part 1 --- PMAP 8521, Spring 2026"
...
Include a simple impact theory graph like @fig-impact-theory showing the program’s basic activities and outcomes. Recall from class and your reading that this is focused primarily on the theory and mechanisms, not on the implementation of the program.

![My neat impact theory](figures/placeholder.png){#fig-impact-theory}
