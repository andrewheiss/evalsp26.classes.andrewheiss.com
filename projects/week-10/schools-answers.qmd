...
schools_clean <- schools |>
  filter(avgrow05 <= 0 & expgrow == 0 | avgrow05 > 0 & expgrow == 1)
```
...
```{r}
model_simple <- lm(avgrow06 ~ avgrow05 + expgrow, data = schools_bw)
