...
.box-6.medium.sp-after[IV fun times]
...
.box-5.medium[Percentages and percentage points]

---

class: middle

.box-5.medium[Summarizing data yourself vs.<br>letting ggplot do it]

---

class: middle

.box-5.medium[Citations with Quarto]

---

class: middle

.box-5.medium[Inline chunks and hidden chunks]
...
.center.small[[Slide from lecture](https://evalsp26.classes.andrewheiss.com/slides/11-slides.html#29)]

---

.box-2.large[Can you review the<br>three IV conditions?]

.center.small[[Slide from lecture](https://evalsp26.classes.andrewheiss.com/slides/11-slides.html#43)]

---

.box-2.large[Why does using instruments mean<br>we can write off the other influences?]

---

.box-2.large[Does this actually work in practice?]

.box-inv-2[I just want to poke holes in every possible instrument story]
...
.center[
<figure>
  <img src="img/11-class/torpedo.png" alt="WWII torpedo" title="WWII torpedo" width="70%">
</figure>
]
