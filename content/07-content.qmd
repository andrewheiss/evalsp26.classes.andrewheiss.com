...
- [**Session 7(8) FAQ slides**](/slides/08-class.html) ([PDF](/slides/08-class.pdf))
- [In-class `.zip` file](/projects/rcts-ipw.zip)
- [Posit.cloud project](https://posit.cloud/spaces/737332/content/12043244)
...
- [Bayesian stats and decision making](/resource/bayes.qmd)
