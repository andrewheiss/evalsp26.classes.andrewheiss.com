...
To make your copying/pasting life easier, each session has an [extensive example page](/example/index.qmd) an accompanying video showing how to work through the different analyses. Copy/paste/tweak liberally from the example pages!
