...
For your first set of FAQs, some questions that I've been getting a lot about AI and LLMs. You already read [this thing about what I think about LLMs](/resource/ai-bs.qmd). This is more detailed.
...
In this class, I don't actually care that much what your final outputs are. I want you do interesting analysis in your problem sets and to make a rigorous and well-designed final project that can potentially measure the causal effect of a real world program. I want you to do neat extensions in your problem sets. But I don't care so much about you getting the exact right answer. That's the whole point of the ✓ grading system.

The point of all the problem sets this semester has been to get you to struggle and learn. The main output for this class isn't the stuff you make—**it's the stuff you learn**.
