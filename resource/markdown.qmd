...
+------------------------------------------+-----------------------------------------------------------------------------+
| `![Image caption](path/to/image.png)`    | ![Image caption](/files/img/eval-hires.png){width=30%}                      |
+------------------------------------------+-----------------------------------------------------------------------------+
...
There are a few different ways to hand-create tables in Markdown—I say "hand-create" because it's normally way easier to use R to generate these things with packages like [{tinytable}](https://vincentarelbundock.github.io/tinytable/) or [{gt}](https://gt.rstudio.com/). The two most common are simple tables and pipe tables. [You should look at the full documentation here](https://quarto.org/docs/authoring/tables.html).
