...
In the primers you were introduced to the pipe operator `|>`, which takes the object on the left of the pipe and passes it as the first argument to the function on the right.
