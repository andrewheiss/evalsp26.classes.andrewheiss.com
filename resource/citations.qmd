...
You can access [a shared group Zotero library of all the non-web-based class reading references](https://www.zotero.org/groups/evalsp26) and link it to your Zotero account to easily cite the course materials. 
...
<a class="btn btn-danger" target="_blank" href="https://www.zotero.org/groups/evalsp26">{{< ai zotero color=white >}}&emsp;Zotero group library</a> &ensp;
